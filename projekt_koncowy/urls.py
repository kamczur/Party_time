...
from imprezy.views import (register_request, homepage, login_request, logout_request, AddParty,
                           PartiesListView, AddGiftView, GiftsListView, ReserveGiftView, GiftReservedView, DeleteGiftView, DeletePartyView, EditPartyView, PartyDetailsView,
...
urlpatterns = [
    ...
    path('gift_reserve/<int:gift_id>/', ReserveGiftView.as_view(), name="reserve-gift"),
    path('gift_reserved/<int:gift_id>/', GiftReservedView.as_view(), name="reserved-gift"),
